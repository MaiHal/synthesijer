...
import synthesijer.scheduler.ALTFP_EXP32;
import synthesijer.scheduler.ALTFP_ABS32;
...
public enum Manager {
	...
	private Manager(){
		...
		addHDLModule("ALTFP_EXP32", null, new ALTFP_EXP32(), false);
		addHDLModule("ALTFP_ABS32", null, new ALTFP_ABS32(), false);
		// floating 64-bit
